      ...
      {sType === 'current' ? (
       <View style={{ flexDirection: 'row' , justifyContent: 'space-between'}}>
        ...
        <View style={{ flexDirection: 'row' , justifyContent: 'space-between'}}>
          ...
          <Button buttonColor='tomato' onPress={() => saveDataAndReset(wType, dateFromChild, startTimeFromChild, endTimeFromChild, weightFromChild, repsFromChild, setsFromChild, intensity, notes, allRestTimes)} mode='contained' style={{marginBottom:20}}>Add Workout</Button>
          <Portal>
